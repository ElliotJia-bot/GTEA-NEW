...
class MiniBatchGTEASTTrain(nn.Module):
    def __init__(self, node_in_dim, edge_in_dim, node_hidden_dim, num_class, num_layers, device, dropout=None):
        ...
        self.edge_layers.append(nn.Linear(edge_in_dim, node_hidden_dim))

        self.edge_attentiion_layers = nn.ModuleList()
        self.edge_attentiion_layers.append(nn.Linear(edge_in_dim, node_hidden_dim))
...
class MiniBatchGTEASTInfer(nn.Module):
    def __init__(self, node_in_dim, edge_in_dim, node_hidden_dim, num_class, num_layers, device, dropout=None):
        super(MiniBatchGTEASTInfer, self).__init__()
