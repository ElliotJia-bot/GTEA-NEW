...
class ATEdgeLSTMTrain(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_lstm_layers, bidirectional, device, dropout=None):
        super(ATEdgeLSTMTrain, self).__init__()
        ...
        self.edge_attentiion_layers.append(LSTM(edge_in_dim, node_hidden_dim, num_lstm_layers, device, bidirectional=bidirectional))
...
class ATEdgeLSTMInfer(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_lstm_layers, bidirectional, device, dropout=None):
        super(ATEdgeLSTMInfer, self).__init__()
