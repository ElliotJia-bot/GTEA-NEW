...
class GTEATransVTrain(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_heads, num_encoder_layers, device, dropout=None):
        super(GTEATransVTrain, self).__init__()
    ...
    def forward(self, nf):
        ...
        for i, (edge_in_layer, edge_layer, edge_att_layer, attn_layer, edge_out_layer, node_layer) in enumerate(zip(self.edge_in_layers, self.edge_layers, self.edge_attentiion_layers, self.attn_layers, self.edge_out_layers, self.node_layers)):
...
class GTEATransVInfer(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_heads, num_encoder_layers, device, dropout=None):
        super(GTEATransVInfer, self).__init__()
