...
class GTEATLSTM1Train(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_lstm_layers, bidirectional, device, dropout=None):
        super(GTEATLSTM1Train, self).__init__()
        ...
        self.edge_attentiion_layers.append(TLSTM1(edge_in_dim, node_hidden_dim, device, num_lstm_layers))
...
class GTEATLSTM1Infer(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, num_class, num_layers, num_lstm_layers, bidirectional, device, dropout=None):
        super(GTEATLSTM1Infer, self).__init__()
